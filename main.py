        ...
        if DATABASE_URL:
            async with AsyncConnectionPool(DATABASE_URL, min_size=1, max_size=20) as db_pool:
                ...
                try:
                    ...
                    await application.shutdown()  # Завершаем приложение при нормальном выходе
        else:
